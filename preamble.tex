...
\newfontfamily\blockmono{Latin Modern Mono}[Scale=0.84]
...
\DefineVerbatimEnvironment{kennelcode}{Verbatim}{%
  fontsize=\fontsize{8.2}{10}\selectfont,
...
\hypersetup{pdftitle={Project Kennel Volume 1}, pdfauthor={Remco van Mook}}

% ---------- justification tolerance for unbreakable mono tokens ----------
\tolerance=1200
\setlength{\emergencystretch}{3em}

% no forced-recto blanks (title-verso is added explicitly in full.tex)
